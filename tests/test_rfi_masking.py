...
from ska_sdp_batch_preprocess.distributed_func import distribute_rfi_masking
from ska_sdp_batch_preprocess.mapped_func import mapped_rfi_mask
import xarray as xr
...
def test_mapped_rfi_mask(test_data: xr.Dataset, mask_pairs):
    ...
    dis_result = mapped_rfi_mask(test_data, mask_pairs)
    result = apply_rfi_masks(test_data, mask_pairs)
