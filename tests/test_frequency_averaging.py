...
def test_distributed_f_avg(test_data: xr.Dataset, client: Client):
    ...
    assert time_distributor.avg_freq(10, 0.5).equals(averaging_frequency(test_data, 10, flag_threshold=0.5))
    assert freq_distributor.avg_freq(10, 0.5).equals(averaging_frequency(test_data, 10, flag_threshold=0.5))
